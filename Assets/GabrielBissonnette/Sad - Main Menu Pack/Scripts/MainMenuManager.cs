...
namespace GabrielBissonnette.SAD
{
    public class MainMenuManager : MonoBehaviour
    {
        ...
        {
            PlayerPrefs.SetInt("EndPosition", Convert.ToInt32(endPosition));
        }
        
        public void SetXapiServer(string xapiServer)
        {
            PlayerPrefs.SetString("XapiServer", xapiServer);
        }

        public void SetXapiKey(string xapiKey)
        {
            PlayerPrefs.SetString("XapiKey", xapiKey);
        }

        public void SetXapiSecret(string xapiSecret)
        {
            PlayerPrefs.SetString("XapiSecret", xapiSecret);
        }
